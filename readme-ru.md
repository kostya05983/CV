...
### Решенные задачи
Ниже выделены задачи с затраченным временем более 2 месяцев общей разработки команды. Фронтенд ребята доводили только к 3 месяцу и затем шло тестирование.
